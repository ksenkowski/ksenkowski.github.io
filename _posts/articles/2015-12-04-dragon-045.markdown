...
image: "/assets/img/articles/dragon/045/cover.jpg"
---
...
<section class="review continued">
	<div class="content gutters">
		...
		<div class="span-6 col">
			...
			<figure>
				<img src="{{ site.loading }}" data-src="{{ site.baseurl }}/assets/img/articles/dragon/045/full-cover.jpg" alt="Full Cover by Dean Morrissey"/>
			...
			<figure>
				<img src="{{ site.loading }}" data-src="{{ site.baseurl }}/assets/img/articles/dragon/045/new-blood.png" alt="Ed Greenwood and Roger Moore take the Stage"/>
			...
			<figure>
				<img src="{{ site.loading }}" data-src="{{ site.baseurl }}/assets/img/articles/dragon/045/evil.png" alt="Evil! SO EVIL!!!"/>
			...
			<figure>
				<img src="{{ site.loading }}" data-src="{{ site.baseurl }}/assets/img/articles/dragon/045/vents.png" alt="HVAC in Dungeons"/>
			...
			<figure>
				<img src="{{ site.loading }}" data-src="{{ site.baseurl }}/assets/img/articles/dragon/045/writing.png" alt="Article Submission Critique"/>
			...
			<figure>
				<img src="{{ site.loading }}" data-src="{{ site.baseurl }}/assets/img/articles/dragon/045/paper-dungeon.png" alt="Paper Dungeons"/>
